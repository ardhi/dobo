...
## 2025-12-10
- [2.1.0] Rewrite the whole thing into class based modules: Connection, Driver, Feature, Schema. Dobo will solely serve as DB Manager in the future

## 2025-12-05
- [2.1.0] Connection now saved in ```this.connections``` as ```Connection``` instance
